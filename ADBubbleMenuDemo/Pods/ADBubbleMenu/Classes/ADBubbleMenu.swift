...
///----
///ADBubbleMenuViewDelegate protocol
protocol ADBubbleMenuViewDelegate: NSObjectProtocol {

    func bubbleMenuButtonWillExpand(_ expandableView: ADBubbleMenuButton)
    func bubbleMenuButtonDidExpand(_ expandableView: ADBubbleMenuButton)
    func bubbleMenuButtonWillCollapse(_ expandableView: ADBubbleMenuButton)
    func bubbleMenuButtonDidCollapse(_ expandableView: ADBubbleMenuButton)
}
...
public class ADBubbleMenuButton: UIView, UIGestureRecognizerDelegate {
    ...
    weak var delegate: ADBubbleMenuViewDelegate?
    ...
    public var homeButtonView: UIView? {
        ...
        set {
            if self.ahomeButtonView != newValue {
                self.ahomeButtonView = newValue
            }

            if self.ahomeButtonView!.isDescendant(of: self) == false {
                self.addSubview(self.ahomeButtonView!)
            }
        }
    }
    ...
    func _defaultInit() {
        ...
        self.tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(ADBubbleMenuButton.handleTapGesture(_:)))
